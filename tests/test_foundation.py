...
async def test_foundation_summary_available_in_coordinator(
    ...
    assert presence_boundary["presence_attribution_enabled"] is False
    ...
    assert guest_unknown_behavior["identity_attribution_enabled"] is False
    ...
    assert multi_occupant_behavior["identity_attribution_enabled"] is False
